  ...
  <div class="flex flex-col xl:flex-row" v-if=is_loading>
    <div class="left-side xl:w-9/12 w-full">
      ...
      <div class="p-4 flex font-bold dark:text-white lg:ml-28 lg:mr-0 md:mx-12">
        <div class="flex items-center mr-8 space-x-1.5 hover:text-greenlogo cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
            <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
          </svg>
          <p>Add to favorites</p>
        </div>
        <div v-if=isOwner() class="flex items-center space-x-1.5 hover:text-greenlogo cursor-pointer" @click=onEdit(post.id)>
        ...
        <div class="cursor-pointer hover:text-greenlogo ml-auto">
      ...
      <div class="md:w-9/12 w-5/6 mx-auto my-3 space-y-3 relative">
        ...
        <div class="flex space-x-5 text-gray-500 dark:text-gray-300">
          <div class="flex items-center space-x-1.5">
            ...
            <p>{{ post.favorite_count }} Favorites</p>
          </div>
          <div class="flex items-center space-x-1.5">
    ...
    <div class="right-side py-3 px-7 xl:w-3/12 w-full dark:text-white bg-gradient-to-t from-gray-100 to-white dark:from-gray-800 dark:to-gray-800">
