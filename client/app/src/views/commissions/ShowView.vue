  ...
  <div class="flex flex-col xl:flex-row relative" v-if=is_loading>
    ...
    <div class="left-side xl:w-9/12 w-full z-0">
      ...
      <div class="p-4 flex font-bold dark:text-white lg:ml-28 lg:mr-0 md:mx-12">
        ...
        <div class="ml-auto" />
        <div class="mr-5">
          <button @click=chat class="px-5 py-1 hover:bg-black hover:text-white dark:hover:text-black dark:hover:bg-white duration-200 ease-in-out border border-black dark:border-white rounded-3xl">
            Chat
          </button>
        </div>
