          ...
          <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
            ...
            <div v-if=auth_store.isAuthen>
              ...
              <ul class="py-1" aria-labelledby="user-menu-button">
                <li>
                  <a @click="() => this.$router.push('/my-collection')" class="cursor-pointer lock py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">My Collection</a>
                </li>
                <li>
